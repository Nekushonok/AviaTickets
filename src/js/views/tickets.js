  ...
  static ticketTemplate(ticket, currency) {
    ...
    <div class="col s12 m6">
      <div class="card ticket-card">
        ...
        <a
          class="waves-effect waves-light btn-small green darken-1 add-favorite ml-auto" id=${ticket.id}
          >Add to favorites <i class="tiny material-icons right">favorite_border</i></a
        >
      </div>
    </div>
    `;
